...
if [ $1 = 'cdn' ]
	...
	filebrowser_url='https://github.com/filebrowser/filebrowser/releases/download/v2.21.1/linux-amd64-filebrowser.tar.gz'
	master_url='https://github.com/1420125167/ccaa/archive/master.zip'
	ccaa_web_url='https://github.com/1420125167/ccaa/raw/master/ccaa_web.tar.gz'
	else
	aria2_url='https://github.com/q3aql/aria2-static-builds/releases/download/v1.36.0/aria2-1.36.0-linux-gnu-64bit-build1.tar.bz2'
	filebrowser_url='https://github.com/filebrowser/filebrowser/releases/download/v2.21.1/linux-amd64-filebrowser.tar.gz'
	master_url='https://github.com/1420125167/ccaa/archive/master.zip'
